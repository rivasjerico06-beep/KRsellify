...
export const metadata = { title: 'Terms of Service — The Maga' }
    ...
    <InfoPageLayout title="Terms of Service" subtitle="Last updated: January 2025" breadcrumb="Terms of Service">
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        <Section title="Acceptance of Terms">
          <p>By accessing or using The Maga, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our site.</p>
        </Section>

        <Section title="Products & Pricing">
          <p style={{ marginBottom: 10 }}>All products listed on The Maga are subject to availability. We reserve the right to:</p>
        ...
        <Section title="Shipping & Delivery">
          <p>Estimated delivery times are not guaranteed. The Maga is not liable for delays caused by shipping carriers, customs, or events outside our control. Risk of loss passes to you upon delivery to the carrier.</p>
        </Section>
        ...
        <Section title="Intellectual Property">
          <p>All content on this site — including logos, product images, text, and design — is the property of The Maga or its licensors. You may not reproduce, distribute, or create derivative works without our written permission.</p>
        </Section>

        <Section title="Limitation of Liability">
          <p>To the fullest extent permitted by law, The Maga is not liable for any indirect, incidental, or consequential damages arising from your use of our site or products. Our total liability shall not exceed the amount you paid for the item in question.</p>
        </Section>
