    ...
    <motion.div
      ...
      <motion.div
        ...
        <div style={{ padding: '20px 22px 24px' }}>
          <p style={{ fontSize: 13, fontWeight: 600, color: 'rgba(255,255,255,0.5)', marginBottom: 6, letterSpacing: '0.06em', textTransform: 'uppercase' }}>The Maga Exclusive</p>
    ...
    <div ref={heroRef} style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
      ...
      <motion.div
        ...
        <motion.p
          ...
          The Maga curates the world's most exceptional crypto memorabilia, gold bars, and rare medallions — each piece authenticated, limited, and ready to become your legacy.
        </motion.p>
    ...
    <div ref={ref} style={{ background: '#020c18', padding: '120px 28px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <motion.div
        ...
        <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.55)', lineHeight: 1.75, marginBottom: 52 }}>
          Join thousands of collectors who trust The Maga for the rarest, most beautiful pieces in the world. Limited stock. Unlimited prestige.
        </p>
...
function LandingFooter() {
  return (
    <div style={{ background: '#010811', borderTop: '1px solid rgba(202,138,4,0.12)', padding: '28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
      <p style={{ fontFamily: 'var(--font-cormorant)', fontSize: 22, fontWeight: 700, color: 'var(--gold)', letterSpacing: '0.08em' }}>THE MAGA</p>
      <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.25)' }}>© {new Date().getFullYear()} The Maga. All rights reserved.</p>
