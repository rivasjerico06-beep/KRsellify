...
const STATS = [
  ...
  { icon: 'fa-users',        title: '2,400+ Collectors', body: 'Happy customers across the globe trust PATRIOT’S ONLINE SHOP for rare finds.', count: 2400 },
...
/* ── Timeline step ───────────────────────────────────────── */
const TIMELINE = [
  { year: '2021', label: 'Founded', body: 'PATRIOT’S ONLINE SHOP was born out of a passion for rare, authenticated collectibles.' },
...
export default function AboutPage() {
  return (
    <InfoPageLayout title="About PATRIOT’S ONLINE SHOP" subtitle="Premium collectibles, verified and shipped with care." breadcrumb="About">
          ...
          <div style={{ background: 'var(--white)', borderRadius: 20, padding: '36px 40px', boxShadow: '0 2px 16px rgba(9,52,89,0.07)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ paddingLeft: 20 }}>
              ...
              <p style={{ fontSize: 15, lineHeight: 1.85, color: 'var(--text-mid)', marginBottom: 14 }}>
                PATRIOT’S ONLINE SHOP was founded with one mission: to make premium collectibles and limited-edition memorabilia accessible to enthusiasts everywhere. What started as a passion for rare finds grew into a trusted marketplace for collectors, investors, and gift buyers worldwide.
              </p>
